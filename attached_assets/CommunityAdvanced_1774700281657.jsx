...
const communityPosts = [
  {
    ...
    time: "2h ago",
    content: "Just completed an amazing sunrise hike! The views were absolutely breathtaking. Can't wait for more routes to be added! 🏔️",
  ...
  },
  {
    ...
    time: "5h ago",
    content: "Looking for hiking buddies this weekend! Anyone interested in exploring some trails together?",
    image: null,
    likes: 12,
    comments: 8
  },
  {
    ...
    time: "1d ago",
    content: "Pro tip: Always bring extra water and snacks, even for shorter hikes. The mountain weather can be unpredictable! 💧🥾",
          ...
          <Card className="p-4 border-0 shadow-lg rounded-2xl">
            <div className="flex gap-3">
              <Avatar className="w-10 h-10">
                <AvatarFallback className="bg-[#C17F59] text-white">You</AvatarFallback>
              </Avatar>
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between mt-3">
                  <Button variant="ghost" size="sm" className="text-[#2D3436]/50 hover:text-[#C17F59]">
          ...
          >
            <Card className="border-0 shadow-sm rounded-2xl overflow-hidden">
              <div className="p-4">
                ...
                <p className="mt-3 text-sm text-[#2D3436]/80 leading-relaxed">
                  {post.content}
                </p>
              </div>
